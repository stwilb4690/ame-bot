...
pub async fn run_ws(
    ...
    let request = Request::builder()
        ...
        .header("Host", std::env::var("KALSHI_API_HOST").unwrap_or_else(|_| {
            match crate::config::app_env() {
                crate::config::AppEnv::Demo => "demo-api.kalshi.com".into(),
                crate::config::AppEnv::Prod => "trading-api.kalshi.com".into(),
            }
        }))
